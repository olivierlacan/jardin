...
class FeaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post features_url, params: { feature: { name: @feature.name, released_at: @feature.released_at } }
    end
  ...
  test "should update feature" do
    patch feature_url(@feature), params: { feature: { name: @feature.name, released_at: @feature.released_at } }
